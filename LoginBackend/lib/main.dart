...
import 'package:flutter_application_1/models/vendedor.dart';
                      ...
                      if (name.isEmpty) {
                        ...
                        if (response.statusCode == 200) {
                         // _displaySuccess('Login Exitoso');
                          ...
                          Vendedor myResponse = Vendedor.fromJson(jsonData);
                          mivendedor = myResponse;
                          print(myResponse.vendedor.toJson());
